...
urlpatterns = [
    ...
    url(r'user/classroom/python/easy$',views.python_easy),
    ...
    url(r'^classroom/(?P<language>\w+)/(?P<difficulty>\w+)/(?P<number>\d+)$',views.language),
    ...
    url(r'^favorite/(?P<category>\w+)$',views.favorite_weapon),
