$(document).ready(function(){
    ...
    $('#javabutton').click(function(){
        $('#difficulty').slideToggle().css('display','inline-block');
        $('.difficulty_selection').remove();
        $('#difficulty').append("<div class='difficulty_selection'> <a href='/classroom/java/easy/11' class='green'> Easy </a> <br> </div>");
    ...
    $('#javascriptbutton').click(function(){
        $('#difficulty').slideToggle().css('display','inline-block');
        $('.difficulty_selection').remove();
        $('#difficulty').append("<div class='difficulty_selection'> <a href='/classroom/javascript/easy/21' class='green'> Easy </a> <br> </div>");
